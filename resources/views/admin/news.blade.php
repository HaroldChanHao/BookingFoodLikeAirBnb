                            				...
                            				<table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                				...
                                				<tbody>
                                					@forelse ($newsData as $newsData)
				                                        ...
				                                        <td>{{$newsData->news_title}} <a href="/infoshow?id={{$newsData->id}}" target="_blank">预览</a></td>
				                                        <td>{{$newsData->news_create}}</td>
				                                        <td>
			                                        			<a href="/admin/news/edit_news?id={{$newsData->id}}">修改</a> <a href="javascript:void(0)" onclick="confirm('确认删除？')?location.href='/admin/news/edit_news?id={{$newsData->id}}&stas=9':'';">删除</a>		                                        		
				                                        </td>
	                           						</tr>												    
												@empty
												    <p>没有数据</p>
