...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">活动分类列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            				...
                            				<table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                				...
                                				<tbody>    
												    ...
												    <tr class="gradeA @if ($loop->index % 2 == 0) 
				                                        ...
				                                        <td><a href="/admin/activity/edit_class?id={{$data->id}}">编辑</a> <a href="javascript:void(0)" onclick="confirm('确认删除？')?location.href='/admin/activity/del_class?id={{$data->id}}':'';">删除</a></td>
	                           						</tr>
												@empty
												    <p>没有数据</p>
												@endforelse
