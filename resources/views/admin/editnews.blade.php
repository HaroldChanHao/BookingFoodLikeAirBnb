                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" enctype="multipart/form-data" method="post" action="?id={{$newsData->id}}">
                                    		@csrf
                                        <div class="form-group">
                                            <label>请输入新闻标题</label>
                                            <input class="form-control" value="{{$newsData->news_title}}" id="newsTitle"  name="newsTitle" placeholder="新闻标题">
                                        </div>
                                        <div class="form-group">
                                            <label>新闻图片</label>
                                            <input class="form-control" type="file" id="newsPic"  name="newsPic[]">
                                            	@if ($newsData->news_pic <> '')
											    <img src="/uploads/{{$newsData->news_pic}}" width="300">								
											@endif
                                       </div>
                                        <div class="form-group">
                                        		<div id="div1">{!!$newsData->news_content!!}</div>
